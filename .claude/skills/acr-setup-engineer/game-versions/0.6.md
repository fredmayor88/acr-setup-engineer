...
- **Tarmac:** the optimal hot pressure is **28 psi, front and rear**. Set the cold pressure
  ...
  **26 psi** on a stage of 8 km or more. Those cold values are a starting guess; the gauge
  routine below settles them. Both axles the same. Make the value legal on the
